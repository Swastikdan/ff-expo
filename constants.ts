export const VITE_PUBLIC_APP_URL = process.env.VITE_PUBLIC_APP_URL as string;
export const SITE_CONFIG = {
  name: 'Film Fanatic',
  description: 'Explore a vast collection of movies and TV shows with Film Fanatic.',
  url: VITE_PUBLIC_APP_URL,
  defaultMetaImage: 'https://ik.imagekit.io/swastikdan/Film-Fanatic/public/ogimage.webp',
  navItems: [
    {
      name: 'Movies',
      slug: 'movies',
...
export type MediaPageSlug = {
  ...
  slug: 'popular' | 'now-playing' | 'top-rated' | 'upcoming' | 'on-the-air' | 'airing-today';
};
